...
ProcessFlow = {
	...
	prepareCustomData: function (owner) {
		...
		if(org_scn_community_unified.adjustProcessFlowModel) {
			that._specialDataModel = org_scn_community_unified.adjustProcessFlowModel(that._specialDataModel, that);
		}
