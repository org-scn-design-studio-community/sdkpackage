...
RadioButtonGroup = {
	...
	prepareCustomData: function (owner) {
		...
		if(org_scn_community_unified.adjustRadioButtonGroupModel) {
			that._specialDataModel = org_scn_community_unified.adjustRadioButtonGroupModel(that._specialDataModel, that);
		}
