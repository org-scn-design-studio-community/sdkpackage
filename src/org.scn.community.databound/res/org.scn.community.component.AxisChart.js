 ...
 */
org_scn_community_databound_AxisChart.prototype = org_scn_community_databound_BaseViz;
org_scn_community_databound_AxisChart.constructor = org_scn_community_databound_AxisChart;
function org_scn_community_databound_AxisChart(d3, options){
	var that = this;
	var properties = {
		xAxisTicks : { 
			value : 5,
