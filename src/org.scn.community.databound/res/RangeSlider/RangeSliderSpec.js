...
function() {
	...
	var spec = {
		id: "RangeSlider",
		name: "databound.RangeSlider",
		requireName: "databoundrangeslider",
		fullComponentName: "org.scn.community.databound.RangeSlider",
		fullComponentPackage: "org.scn.community.databound/res/RangeSlider",
		script: "org.scn.community.databound/res/RangeSlider/RangeSlider",
		scriptSpec: "org.scn.community.databound/res/RangeSlider/RangeSliderSpec",
		min: false
	};
	...
	spec.spec = 
{
  ...
  "selectedKey2": {
    "opts": {
      "apsControl": "text",
      "cat": "Display",
      "desc": "Technical Proprty For Selected Key 2",
      "noAps": true,
      "noZtl": false,
      "tooltip": "Technical Proprty For Selected Key 2",
      "ztlFunction": "-get",
      "ztlType": "String"
    },
    "template": "String",
  ...
  "selectedKeys": {
    "opts": {
      "apsControl": "text",
      "cat": "Display",
      "desc": "Technical Proprty For Selected Keys",
      "noAps": true,
      "noZtl": false,
      "tooltip": "Technical Proprty For Selected Keys",
      "ztlFunction": "-get",
      "ztlType": "String"
    },
    "template": "String",
  ...
  "selectedText2": {
    "opts": {
      "apsControl": "text",
      "cat": "Display",
      "desc": "Technical Proprty For Selected Text 2",
      "noAps": true,
      "noZtl": false,
      "tooltip": "Technical Proprty For Selected Text 2",
      "ztlFunction": "-get",
      "ztlType": "String"
    },
    "template": "String",
...
{};
	...
	spec.specAbout = 
{
  "description": "Data Range Slider",
  "icon": "RangeSlider.png",
  "title": "Data Range Slider 2.0",
  "topics": [
    {
      "content": "Data Range Slider",
