...
AreaMicroChart = {
	...
	prepareCustomData: function (owner) {
		...
		if(org_scn_community_unified.adjustAreaMicroChartModel) {
			that._specialDataModel = org_scn_community_unified.adjustAreaMicroChartModel(that._specialDataModel, that);
		}
