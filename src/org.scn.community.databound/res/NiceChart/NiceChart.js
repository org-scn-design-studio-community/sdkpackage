...
/*AUTO PROPERTIES - END*/
	...
	this.onPropertyChanged = function () {
		...
		that._canvas.style.width = (that._jqThis.outerWidth() - legendSize) + 'px';
		that._canvas.style.height =  that._jqThis.outerHeight() + 'px';
		if(that._chartInstance) {
			that._chartInstance.width = (that._jqThis.outerWidth() - legendSize);
			that._chartInstance.height =  that._jqThis.outerHeight();
		}
//    				if(that._chart) {
//        				that._chart.scale.width = (that._jqThis.outerWidth() - legendSize);
//        				that._chart.scale.height =  that._jqThis.outerHeight();
//    				}
		if(that._DLegendPosition == "Left") {
			...
			that._legend.style.left = (that._jqThis.outerWidth() - legendSize + 10) + 'px';
		}
