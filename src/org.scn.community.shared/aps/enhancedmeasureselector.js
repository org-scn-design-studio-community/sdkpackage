/**
 * Enhanced Measure Selector Handler
 */
define(["./complexitem"], function () {
	/**
	 * Enhanced Measure List
	 */
	sap.ui.commons.ComboBox.extend("org.scn.community.aps.EnhancedMeasureList", {
		metadata : {
			properties : {
				dataset : {
					defaultValue : "databound"
				}
			}
		},
		init : function () {
		...
		notifyDataChange : function () {
			this.destroyItems();
			if (propertyPage && propertyPage.flattenedData) {
