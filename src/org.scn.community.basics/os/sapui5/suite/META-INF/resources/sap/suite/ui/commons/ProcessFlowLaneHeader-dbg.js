...
sap.suite.ui.commons.ProcessFlowLaneHeader._constants = {
  ...
  , sOuterCircleColor : "#ffffff" // white, @sapUiLightestBG = #ffffff
  , sOuterCircleStrokeColor : "#dddddd" // @sapUiLightBorder = #dddddd
  , nOuterCircleStrokeWidth: 1
  , sSectorPositiveColor : "#61a656" // @SAPUIChartGood = #61a656
  , sSectorNegativeColor : "#d32030" // @SAPUIChartBad = #d32030
  , sSectorNeutralColor : "#ffffff"  // white, @sapUiLightestBG = #ffffff
  , sSectorPlannedColor : "#999999"  // lighten (@SAPUIChartNeutral, 10) = #999999
  , sEllipsis : '...'
  , nEllipsisLength : 3
};
...
sap.suite.ui.commons.ProcessFlowLaneHeader.prototype._renderDonutPercentages = function(oRm) { // EXC_SAP_006_1
  var aStateAmounts = this.getState()
      ...
      , sOuterCircleColor = sap.suite.ui.commons.ProcessFlowLaneHeader._constants.sOuterCircleColor
  ...
  if (aStateAmounts &&
    ...
    this._renderCircle(oRm, sOuterCircleColor, sOuterCircleStrokeColor, nOuterCircleStrokeWidth,
    ...
    if (nGaps > 0) {
      ...
      this._renderCircle(oRm, sOuterCircleColor, sColor, nRingThickness, nPositionX, nPositionY,
...
sap.suite.ui.commons.ProcessFlowLaneHeader.prototype._renderCircle =
  function (oRm, sColor, sStrokeColor, nStrokeWidth, nPositionX, nPositionY, nRadius) { // EXC_JSHINT_034
  oRm.write("<circle");
  oRm.writeAttribute("id", this.getId() + "-donut-circle");
  oRm.writeAttribute("fill", sColor);
  oRm.writeAttribute("stroke", sStrokeColor);
...
sap.suite.ui.commons.ProcessFlowLaneHeader.prototype._renderDonutSectors =
  ...
  while (i < nDefLength) {
    ...
    oRm.writeAttribute("fill", oSector.color);
