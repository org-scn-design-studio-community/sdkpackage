...
define(["./../../../org.scn.community.shared/os/viz-modules/SDKCore",
	...
	function MockUp() {
    	...
    	this.componentInfo.description = "Useful for quickly injecting HTML content into a Design Studio application. Can also be used to execute exploratory JavaScript tests. JavaScript not recommended for permanent productive use. You can make sowcases for further requirements on new components."
