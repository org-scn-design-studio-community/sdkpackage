...
var ownComponentName = "org.scn.community.basics.PasswordField";
...
sap.ui.commons.PasswordField.extend(ownComponentName, {

  	initDesignStudio: function() {
		var that = this;
		this._ownScript = _readScriptPath();
		
		this.addStyleClass("scn-pack-PasswordField");
