...
function SimpleMapD3(o) {
  ...
  smd.constructor = function(options) {
    ...
    if (typeof options.d3Object === 'undefined') {
      throw new Error('Simple Map requires D3.');
    }
    options.legendFormatter = options.legendFormatter || options.d3Object.format(',');
    // Extend defaults
    ...
    smd.events = smd.options.d3Object.dispatch('dataLoaded', 'rendered');
  ...
  smd.getData = function() {
	  smd.options.d3Object.json(smd.options.datasource, function(data) {
      smd.data = data;
      smd.loadData();
    });
  ...
  smd.drawCanvas = function() {
    ...
    smd.container = smd.options.d3Object.select(smd.options.container);
  ...
  smd.projection = function() {
    ...
    if (typeof projFunc == 'undefined' ||
      typeof smd.options.d3Object.geo[projFunc] != 'function') {
      projFunc = 'albersUsa';
    }
    
    smd.centroid = smd.options.d3Object.geo.centroid(smd.data);
    smd.projection = smd.options.d3Object.geo[projFunc]()
      .scale(1000)
    ...
    smd.projPath = smd.options.d3Object.geo.path()
  ...
  smd.makeColorRange = function() {
    ...
    if (typeof scaleFunc != 'function') {
      scaleFunc = smd.options.d3Object.scale[scaleFunc];
    } 
  ...
  smd.dragging = false;
  smd.drag = function() {
    smd.dragCanvas = smd.options.d3Object.behavior.drag()
      .on('drag', function(d) {
        ...
        smd.options.d3Object.event.sourceEvent.stopPropagation();
        d.x += smd.options.d3Object.event.dx;
        d.y += smd.options.d3Object.event.dy;
    ...
    // Simple drag
    smd.dragSimple = smd.options.d3Object.behavior.drag()
      .on('drag', function(d,i) {
        d.x += smd.options.d3Object.event.dx;
        d.y += smd.options.d3Object.event.dy;
        
        smd.options.d3Object.select(this)
      ...
      .on('dragend', function(d) {
    	  smd.options.d3Object.select(this).classed('dragging', false);
      });
  ...
  smd.drawGraticule = function() {
    ...
    smd.graticule = smd.options.d3Object.geo.graticule();
  ...
  smd.drawLegend = function() {
    var qs;
    var formatter = smd.options.legendFormatter || smd.options.d3Object.format(',');
    var unit = 10;
    var width = smd.options.legendWidth || (smd.width / 5);
    var scale = smd.options.legendScale || 1;
    var min = smd.options.d3Object.min(smd.valuesSet);
    var max = smd.options.d3Object.max(smd.valuesSet);
    ...
    smd.featureGroup
      ...
      .enter().append('path')
        ...
        .on('mouseover', function(d) {
          ...
          // Styles
          smd.options.d3Object.select(this).style(smd.options.stylesHover);
        })
